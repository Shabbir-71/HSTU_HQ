...
<body>
    ...
    <div class="search-body">
      <form class="search_form" action="upload_feedback.php" method="post" enctype="multipart/form-data">
          <table class="content-table">
          <thead>
            <tr>
              <th colspan='2'>Upload Questions [Admin]</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>Academic Year</td>
              <td><input type="text" name="up_year" maxlength="4"></td>
            </tr>
            <tr>
              <td>Level</td>
              <td><select name="up_level">
            ...
            <tr>
              <td>Degree</td>
              <td><input type="text" name="up_degree" maxlength="100"></td>
            </tr>
            <tr>
              <td>Department</td>
              <td><input type="text" name="up_department" maxlength="100"></td>
            </tr>
            <tr>
              <td>Course Code</td>
              <td><input type="text" name="up_code" maxlength="20"></td>
            </tr>
            <tr>
              <td>Course Title</td>
              <td><input type="text" name="up_title" maxlength="100"></td>
            </tr>
            <tr>
              <td>Question File (PDF)</td>
