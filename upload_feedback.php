...
<head>
    ...
    <title>HSTU HQ | Admin Upload</title>
    ...
    <div class="search-body">
      <?php
          ...
          if(move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder))
          {
            ...
            $query_year = $_POST['up_year'];
            $query_level = $_POST['up_level'];
            $query_semester = $_POST['up_semester'];
            $query_degree = $_POST['up_degree'];
            $query_department = $_POST['up_department'];
            $query_code = $_POST['up_code'];
            $query_title = $_POST['up_title'];
            $query_link = "files/" . basename( $_FILES['file']['name']);

            $sql = "INSERT INTO question(year_var, level_var, semester, degree, department, course_code, course_title, link) VALUES ('" . $query_year . "', '" . $query_level . "', '" . $query_semester . "', '" . $query_degree . "', '" . $query_department . "', '" . $query_code . "', '" . $query_title . "', '" . $query_link . "');";
            $result = $conn->query($sql);

            echo "The question file '". basename( $_FILES['file']['name']). "' is successfully uploaded into the database.\n";
            $conn->close();
          }
          else {
