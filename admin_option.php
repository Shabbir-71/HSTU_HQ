...
<head>
    ...
    <title>HSTU HQ | Admin Options</title>
...
<body>
    ...
    <div class="admin-option">
        ...
        <thead>
          <tr>
            <th colspan="1">Admin Actions</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <tr><td><a href="admin_upload.php">Question Upload</a></td></tr>
          </tr>
          <tr>
            <tr><td><a href="admin_database.php">Question Database Control</a></th>
          </tr>
          <tr>
            <tr><td><a href="admin_upload_database.php">User Uploads</a> </th>
          </tr>
          <tr>
            <tr><td><a href="admin_request_database.php">User Requests</a> </th>
          </tr>
        </tbody>
      </table>
    </div>
